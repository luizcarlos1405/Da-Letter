...
function Particles:emit(ParticleDamping, SpreadAngle, ParticleImage, Number, Speed, LifeTime, ParticleRed, ParticleGreen, ParticleBlue, EmitX, EmitY, EmitAngle, YminAceleration, YmaxAcleretion)
    ...
    system:setLinearAcceleration(0, YminAceleration, 0, YmaxAcleretion)
	system:emit(Number)
